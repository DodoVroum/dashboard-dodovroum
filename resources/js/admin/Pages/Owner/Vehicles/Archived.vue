<template>
  <div class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-xl overflow-hidden">
      ...
      <!-- Cartes (mobile, < lg) -->
      <div v-if="vehicles.length > 0" class="lg:hidden divide-y divide-slate-100">
        <MobileListCard
        ...
        >
          <template #media>
            ...
            />
            <component v-else :is="getIcon(vehicle.type)" class="w-6 h-6 text-slate-400 m-auto" />
          </template>
          ...
          <template #metric>{{ formatPrice(vehicle.pricePerDay || vehicle.price || 0) }} CFA/j</template>
          <template #default>
            <div class="flex items-center gap-2 pt-1">
              ...
              <form :action="`/owner/vehicles/${vehicle.id}/reactivate`" method="POST" class="flex-1">
      ...
      <div v-if="vehicles.length > 0" class="hidden lg:block overflow-x-auto">
      <table class="w-full">
